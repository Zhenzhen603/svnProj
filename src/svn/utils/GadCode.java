...
/**
 * Created by ZhenZhen on 2018/4/22.
 */
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(int j=16;j<18;j++){
            ...
            for (int i = 2; i < 12; i++) {
                ...
                String sql01 = "select DISTINCT revision from actions_original where committer='fschumacher'and changed_date like ?";
...
//
                ...
                //这是一个月的数据,统计后插入数据库
                String sql03A = "insert into gadcode values (?,?,?,?,?)";
