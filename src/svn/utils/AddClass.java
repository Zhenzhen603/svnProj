...
//
                    ...
                    while (rs03.next()) {
                        ...
                        for (String s2 : ss) {
                            ...
                            //定义方法函数的格式
                            String fx01 = "public class";
                            String fx02 = "final class";
                            String fx03 = "abstract class";


                            if (s2.substring(0, 1).equals("+")) {

                                if (s2.indexOf(fx01) != -1 || s2.indexOf(fx02) != -1 || s2.indexOf(fx03) != -1) {
                                    addLine++;
                                }
            ...
            //这是一个月的数据,统计后插入数据库
            String sql03A = "insert into class values (?,?,?,?,?)";
